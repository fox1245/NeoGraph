<!-- neograph-i18n: source=benchmarks/README.md locale=ja source_sha256=beca50aa71f45489f6f78556e6a7225c04c3891ac9c093f5aeda1a4fe50a0620 -->
...
出力形式は `workload<TAB>iters<TAB>total_ms<TAB>per_iter_us` です。
どの側も同じなので、差分は簡単です。

## 2026-04-19 の番号に使用される環境
...
数値はハードウェアによって異なりますが、比率は安定している必要があります。
~20%以内。
