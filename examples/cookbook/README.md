...
| [`openrouter-provider/`](openrouter-provider/) | OpenRouter fixed DeepSeek provider surfaces: built-in `OpenAIProvider` against the compatibility endpoint and a custom Python `Provider` using direct HTTP. |
